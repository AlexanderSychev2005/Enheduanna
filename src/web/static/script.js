...
const PROVENIENCE_COORDS = {
    "Nineveh": [36.3594, 43.1528], "Umma": [31.6672, 45.8875], "Girsu": [31.5620, 46.1776],
    "Nippur": [32.1264, 45.2334], "Puzriš-Dagan": [32.0582, 45.2890], "Kanesh": [38.8500, 35.6330],
    "Assur": [35.4567, 43.2625], "Uruk": [31.3242, 45.6372], "Ur": [30.9617, 46.1051],
    "Ugarit": [35.6019, 35.7822], "Sippar": [33.0588, 44.2522], "Nimrud": [36.0981, 43.3289],
    "Hattusa": [40.0197, 34.6153], "Mari": [34.5494, 40.8900], "Ebla": [35.7980, 36.7980],
    "Susa": [32.1906, 48.2578], "Babylon": [32.5425, 44.4211], "Nuzi": [35.3700, 44.2549],
    "Irisagrig": [32.0625, 45.2428], "Persepolis": [29.9350, 52.8900], "Kish": [32.5403, 44.6047],
    "Larsa": [31.2858, 45.8536], "Garšana": [31.4432, 46.1191], "Emar": [35.9868, 38.1114],
    "Isin": [31.8850, 45.2686], "Ešnunna": [33.4842, 44.7283], "Šaduppum": [33.3095, 44.4671],
    "Nerebtum": [33.3031, 44.5843], "Šuruppak": [31.7774, 45.5098], "Kisurra": [31.8381, 45.4806],
    "Adab": [31.9473, 45.6263], "Huzirina": [37.0503, 38.9061], "Pī-Kasî": [32.1316, 44.6388],
    "Tuttul": [35.9575, 39.0475], "Amarna": [27.6453, 30.8964], "Zabalam": [31.7433, 45.8767],
};
